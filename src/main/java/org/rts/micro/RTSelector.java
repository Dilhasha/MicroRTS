...
public class RTSelector {
    public static void main(String[] args) throws Exception {
        String repoName = "org/rts/micro";
        int prNumber = 1;
        String monitoringURL = "http://localhost:16686";
        List<String> repos = readRepoList();
        ...
        for (String repo : repos) {
            ...
            Map<String, Set<String>> testToServicesMap = MappingsProvider.getTestToSvcMapping(repo);
            // Get the matching tests
            Set<String> matchingTests = getMatchingTests(allAffectedServices, testToServicesMap);
            System.out.println("Matching tests for repo " + repo + ": " + matchingTests);
        }
    }
